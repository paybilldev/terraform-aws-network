<p align="center">
  <a href="https://paybill.dev" target="_blank">
    <picture>
      <img src="./static/aws-network.png" alt="Banner" />
    </picture>
  </a>
</p>

### AWS Network and Subnets Terraform Module

This Terraform setup provisions a complete AWS network foundation. It can **create a VPC or use an existing one**, generate **public and private subnets**, optionally set up **VPN connectivity**, and configure **VPC Endpoints** for private access to AWS services. It also supports **Direct Connect**, custom subnet architecture, and outputs all key network IDs for use by other infrastructure modules.
...
| <a name="module_custom_subnets"></a> [custom\_subnets](#module\_custom\_subnets) | ./subnets | n/a |
